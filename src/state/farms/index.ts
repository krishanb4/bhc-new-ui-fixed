...
import {
  ...
  fetchFarmUserEarningsBHC,
  fetchFarmUserAllowancesBHC,
...
export const fetchFarmUserDataAsyncBHC = (account) => async (dispatch) => {
  const userFarmAllowances = await fetchFarmUserAllowancesBHC(account)
